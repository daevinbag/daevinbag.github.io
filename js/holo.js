(function () {
  const projects = {
    ...
    coffeerun: {
      ...
      desc: 'A Strava-like application for tracking activity and earning rewards. Developed using Flutter and Firebase, the app allows users to start activities through the app (walking, running, biking, etc.) and earn rewards at participating businesses. Working on this project helped me learn about working with a team of developers and meeting the needs of a sponsor while keeping realistic goals. This app differentiates itself from other ativity apps like Strava by focusing on the local scenery of the area that you are using the app (in this case Hawaii).',
